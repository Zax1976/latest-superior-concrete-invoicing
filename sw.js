...
const CACHE_NAME = 'jstark-invoicing-v1.6.3'; // Updated version - Enhanced validation, calculator precision, and performance
const urlsToCache = [
  './',
  './index.html',
  './css/styles.css',
  './css/print.css',
  './js/security.js', // Added security utilities
  './js/validation.js', // Added enhanced form validation
  './js/app.js',
  './js/calculator.js',
  './js/invoice.js',
  './js/storage.js',
